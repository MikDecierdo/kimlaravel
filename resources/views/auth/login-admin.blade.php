...
<head>
    ...
    <title>SOPC Voting System - Admin Login</title>
    ...
    <style>
        ...
        * {
        ...
        .left-pane::before {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(to bottom, rgba(234, 179, 8, 0.3), rgba(234, 179, 8, 0.8));
        }
