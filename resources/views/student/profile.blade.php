        ...
        <div class="profile-card">
                ...
                <div class="profile-avatar-wrap">
                    <div class="profile-avatar" id="avatarBtn" onclick="document.getElementById('avatarInput').click()">
                        @if($student->profile_picture)
                            <img id="avatarPreview" src="{{ $student->profile_picture }}" alt="{{ $student->name }}"
                                 style="width:100%;height:100%;object-fit:cover;">
                        @else
                            <span id="avatarInitial">{{ strtoupper(substr($student->name, 0, 1)) }}</span>
            ...
            <div class="profile-header-info">
                ...
                <span class="profile-badge">
                    ...
                    {{ $student->department }} &mdash; {{ $student->year_level ?? 'Student' }}
                </span>
            </div>
        </div>
            ...
            <div class="profile-grid">
                <div class="form-group">
                    ...
                    <input type="text" name="first_name" class="form-control"
                           value="{{ old('first_name', $student->name) }}" required>
                </div>
                <div class="form-group">
            ...
            <div class="profile-grid">
                <div class="form-group full">
                    ...
                    <div class="pw-wrapper">
                        <input type="password" name="current_password" id="currentPw" class="form-control"
                ...
                <div class="form-group">
                    ...
                    <div class="pw-wrapper">
                        <input type="password" name="password_confirmation" id="confirmPw" class="form-control"
